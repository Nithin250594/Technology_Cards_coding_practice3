...
const App = () => (
  <div className="technologies-bg">
    <h1 className="tech-title"> Learn 4.0 Technologies</h1>
    ...
    <ul className="tech-cards">
      {cardsList.map(eachCard => (
        <CardItem
          key={eachCard.id}
          cardTitle={eachCard.title}
          cardDescription={eachCard.description}
          imageUrl={eachCard.imgUrl}
          className={eachCard.className}
        />
      ))}
    </ul>
  </div>
